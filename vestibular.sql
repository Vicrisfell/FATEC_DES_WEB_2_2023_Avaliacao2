...
CREATE TABLE `vestibular` (
  `CPFID` int(11) NOT NULL,
  `Name` varchar(255) NOT NULL,
  `telefone` int(15) NOT NULL,
  `campoescola` varchar(255) not NULL
...
INSERT INTO `vestibular` (`CPFID`, `Name`, `telefone`, `campoescola`) VALUES
(1, 'Orlando', 'Saraiva'),
(2, 'Andrew', 'Tannembaum');
...
--
ALTER TABLE `vestibular`
  MODIFY `CPFID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
